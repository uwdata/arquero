...
/**
 * Annotate an expression to compute rolling aggregate or window
 ...
 * @param {string|Function|Object} expr The expression to annotate.
 ...
 *  should ignore peer values (ties). If false (the default), the window frame
 *  will  expand to include all peers. If true, the window frame will be
 *  defined by the frame offsets only. This parameter only affects pperations
 *  that depend on the window frame: aggregate functions and the first_value,
